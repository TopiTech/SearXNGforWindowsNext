  ...
  <div id="search_header">
    ...
    <div id="search_view">
      <div class="search_box">
        <input id="q" name="q" type="text" aria-label="{{ _('Search for...') }}" placeholder="{{ _('Search for...') }}" tabindex="1" autocomplete="off" autocapitalize="none" spellcheck="false" autocorrect="off" dir="auto" value="{{ q or '' }}">
