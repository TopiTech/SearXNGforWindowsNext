...
OUTPUT_FORMATS = ['html', 'csv', 'json', 'rss', 'json_lite']
...
SCHEMA: dict[str, t.Any] = {
    ...
    'search': {
        ...
        'suspended_times': {
            'SearxEngineAccessDenied': SettingsValue(numbers.Real, 900),
            'SearxEngineCaptcha': SettingsValue(numbers.Real, 900),
            'SearxEngineTooManyRequests': SettingsValue(numbers.Real, 600),
            'cf_SearxEngineCaptcha': SettingsValue(numbers.Real, 3600),
            'cf_SearxEngineAccessDenied': SettingsValue(numbers.Real, 1800),
            'recaptcha_SearxEngineCaptcha': SettingsValue(numbers.Real, 3600),
        },
