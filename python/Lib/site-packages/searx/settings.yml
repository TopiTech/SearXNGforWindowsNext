...
search:
  ...
  suspended_times:
    ...
    cf_SearxEngineAccessDenied: 900
    # ReCAPTCHA
...
engines:
  ...
  - name: littlelayer
    ...
    categories: [general, blogs]
    paging: false
    search_url: https://litterlayer.com/load_results/?q={query}&page={pageno}
    headers:
    ...
    inactive: true
    about:
      website: https://littlelayer.com
      description: Indie search and bookmarking community
      results: JSON
